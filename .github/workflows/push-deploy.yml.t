...
jobs:
  ...
  deploy:
    ...
    steps:
      ...
      - name: Setup AWS Secrets Manager (Vault)
        if: ${{ secrets.VAULT_ENABLED == 'true' }}
        env:
          AWS_REGION: ${{ secrets.AWS_REGION || 'us-east-1' }}
          AWS_ACCESS_KEY_ID: ${{ secrets.AWS_ACCESS_KEY_ID }}
          AWS_SECRET_ACCESS_KEY: ${{ secrets.AWS_SECRET_ACCESS_KEY }}
          VAULT_SECRET_PREFIX: ${{ secrets.VAULT_SECRET_PREFIX || 'medical-bible' }}
        ...
        run: |
          ...
          ./scripts/setup-vault.sh "${{ inputs.environment }}"
      ...
      - name: Generate .env file
        run: |
          ...
          VAULT_ENABLED=${{ secrets.VAULT_ENABLED || 'false' }}
          VAULT_REGION=${{ secrets.AWS_REGION || 'us-east-1' }}
          VAULT_SECRET_PREFIX=${{ secrets.VAULT_SECRET_PREFIX || 'medical-bible' }}
